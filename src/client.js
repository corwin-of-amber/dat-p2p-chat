...
const swarm = require('./net/discovery-swarm-web-thin');
...
class FeedClient extends SwarmClient {
    ...
    async create(asMaster) {
        var feed = this._mkfeed(null);
    ...
    _mkfeed(key) {
        var feed = hypercore(this.opts.storage, key, DEFAULT_FEED_OPTS);
